...
// Я ТОЛЬКО ИСПРАВИЛ ПУТЬ ЗДЕСЬ, ВСЕ ОСТАЛЬНОЕ - ВАШ КОД
    ...
    <html lang="en" className="dark">
      <head>
        ...
        <Script
          ...
          src="https://www.googletagmanager.com/gtag/js?id=G-EHD6NBQZHV"
        />
        <Script
          id="google-analytics"
          strategy="afterInteractive"
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: 'none' }}
            src="https://www.facebook.com/tr?id=486823147342957&ev=PageView&noscript=1"
          />
        </noscript>
        ...
        <AnimatePresence mode="wait">
          {isLoading ? (
            <motion.div
              ...
              // ВАШ ОРИГИНАЛЬНЫЙ КЛАСС ДЛЯ КОНТЕЙНЕРА ЗАГРУЗЧИКА
              className="loading-container" 
            >
              {/* ВАША ОРИГИНАЛЬНАЯ ВЕРСТКА И АНИМАЦИЯ ЛОГОТИПА */}
              <motion.div
