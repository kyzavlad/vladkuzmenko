...
export const metadata = pageMeta(
  ...
  "SaaS-платформи, маркетплейси, AI-продукти, клієнтські портали та конверсійні сайти — від MVP до production-систем. Реальні етапи, реальні скриншоти, без вигаданих метрик.",
);
