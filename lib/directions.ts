...
const en: DirectionCopy = { eyebrow: "Choose your entry point", titleA: "What do you want to ", titleB: "strengthen now?", desc: "Four independent directions. Pick the result you need and move through one clear next step.", outcomeLabel: "What you get", items: {
  ...
  performance: { short: "Performance", label: "Performance", title: "Performance", outcome: "A fast, repeatable complete-meal option for the moments when a busy day makes normal food inconvenient.", text: "Starting with Performance Complete: a 17-meal powdered-food concept built around work, training, travel and consistency, validated before any paid scale.", tags: ["Complete meal", "60 sec", "Active schedule", "Routine"], cta: "Explore Performance" },
} };
...
const ua: DirectionCopy = { eyebrow: "Оберіть точку входу", titleA: "Що ви хочете ", titleB: "посилити зараз?", desc: "Чотири самостійні напрями. Оберіть потрібний результат і переходьте до одного зрозумілого наступного кроку.", outcomeLabel: "Що ви отримуєте", items: {
  ...
  performance: { short: "Performance", label: "Performance", title: "Performance", outcome: "Швидкий і повторюваний повноцінний прийом їжі для моментів, коли щільний день робить звичайне харчування незручним.", text: "Починаємо з Performance Complete: концепту на 17 прийомів їжі для роботи, тренувань, дороги та стабільності, який спочатку проходить перевірку попиту.", tags: ["Complete meal", "60 сек", "Активний графік", "Режим"], cta: "Відкрити Performance" },
} };
...
const ru: DirectionCopy = { eyebrow: "Выберите точку входа", titleA: "Что вы хотите ", titleB: "усилить сейчас?", desc: "Четыре самостоятельных направления. Выберите нужный результат и переходите к одному понятному следующему шагу.", outcomeLabel: "Что вы получаете", items: {
  ...
  performance: { short: "Performance", label: "Performance", title: "Performance", outcome: "Быстрый и повторяемый полноценный приём пищи для моментов, когда плотный день делает обычное питание неудобным.", text: "Начинаем с Performance Complete: концепта на 17 приёмов пищи для работы, тренировок, дороги и стабильности, который сначала проходит проверку спроса.", tags: ["Complete meal", "60 сек", "Активный график", "Режим"], cta: "Открыть Performance" },
} };
