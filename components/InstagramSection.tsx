...
const instagramPosts = [
  ...
  { id: 7, image: '/1.webp', caption: 'Innovation meets execution 🚀' },
  { id: 8, image: '/2.webp', caption: 'Building tomorrow today 🔮' },
  { id: 9, image: '/3.webp', caption: 'Success mindset workshop 📚' },
  { id: 10, image: '/case-study-8.webp', caption: 'Case study presentation 📊' },
];
