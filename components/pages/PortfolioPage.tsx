...
export function PortfolioPage() {
  ...
  return (
    <div className="bg-black text-white min-h-screen">
            ...
            <div className="container mx-auto px-4 max-w-6xl">
              ...
              <div className="grid md:grid-cols-2 gap-5">
                {projects.map((p) => {
                  ...
                  const caseHref = p.caseSlug
                    ? `${localeBase}/work/${p.caseSlug}`
                    : undefined;
                  return (
                    <article key={p.key} className="luxe-card overflow-hidden flex flex-col">
                      {p.shots.length > 0 && (
                      ...
                      <div className="p-6 flex flex-col flex-1">
                        ...
                        <div className="mt-5 flex flex-col sm:flex-row gap-2.5">
                          ...
                          <RequestSimilar project={c.name} locale={locale} label={ui.requestSimilar} primary={!caseHref} />
                        </div>
                      </div>
                    </article>
                  );
      ...
      {/* Bridge to the focused product-development page */}
...
function RequestSimilar({
  ...
  return (
    ...
    >
      <Button
        className={cn(
          "max-sm:w-full h-auto min-h-11 px-5",
          primary
            ? "premium-button"
