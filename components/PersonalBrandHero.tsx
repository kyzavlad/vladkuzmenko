  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="absolute inset-0">
        ...
        {/* Explosion Mask Effect (This part remains unchanged) */}
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1920 1080" preserveAspectRatio="none">
          {/* ... ваш сложный SVG-код маски остается здесь без изменений ... */}
        </svg>
      ...
      {/* ==================================================================== */}
      {/* ИЗМЕНЕНА СТРУКТУРА ДЛЯ ПРАВИЛЬНОГО ПОЗИЦИОНИРОВАНИЯ */}
      {/* ==================================================================== */}
      <div className="relative z-10 container mx-auto px-6 h-screen flex flex-col justify-center items-center text-center">
        
        {/* Контейнер для основного контента (заголовок, кнопки, статистика) */}
        {/* Он будет занимать основное пространство, но не все 100% высоты */}
        ...
        {/* ==================================================================== */}
        {/* ИНДИКАТОР ПЕРЕМЕЩЕН СЮДА И ОТВЯЗАН ОТ АБСОЛЮТНОГО ПОЗИЦИОНИРОВАНИЯ */}
        {/* ==================================================================== */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1, delay: 1 }}
          className="w-full pb-4" // Отступ снизу для всей секции
        >
