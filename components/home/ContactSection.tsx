...
const COPY: Record<Lang, {
  ...
  en: {
    eyebrow: "Next step",
    titleA: "Have something to build? ",
    titleB: "Start with the real task.",
    desc: "Tell me what you want to improve, launch or simplify. Book a call if talking is faster, or send the context here and I will take it from there.",
    callTitle: "Book a call",
    callDesc: "Choose a convenient time and we will focus on the task, current constraints and the most useful next step.",
    formTitle: "Send the context directly",
  },
  ua: {
    eyebrow: "Наступний крок",
    titleA: "Є задача? ",
    titleB: "Почнімо з неї.",
    desc: "Коротко опишіть, що хочете покращити, запустити або спростити. Якщо швидше поговорити, оберіть час дзвінка. Якщо ні, надішліть контекст тут.",
    callTitle: "Записатися на дзвінок",
    callDesc: "Оберіть зручний час. На дзвінку зосередимося на задачі, поточних обмеженнях і найкориснішому наступному кроці.",
    formTitle: "Надіслати контекст напряму",
  },
  ru: {
    eyebrow: "Следующий шаг",
    titleA: "Есть задача? ",
    titleB: "Начнём с неё.",
    desc: "Коротко опишите, что хотите улучшить, запустить или упростить. Если быстрее поговорить, выберите время звонка. Если нет, отправьте контекст здесь.",
    callTitle: "Записаться на звонок",
    callDesc: "Выберите удобное время. На звонке разберём саму задачу, текущие ограничения и самый полезный следующий шаг.",
    formTitle: "Отправить контекст напрямую",
  },
};
