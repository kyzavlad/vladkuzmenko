...
const COPY: Record<Lang, {
  ...
  en: {
    ...
    titleA: "Build things that ",
    titleB: "work in the real world.",
    p1: "My focus is simple: turn attention into demand, demand into working systems, and ideas into products people can actually use. The tools change; the standard does not.",
    p2: "I apply the same standard outside client work: training, technology, machines, environment and decisions that compound into better execution over a long horizon.",
    lanes: [
      { title: "Business & systems", text: "Demand, websites, AI, automation and sales treated as one path from attention to a measurable business result." },
      { title: "Discipline & performance", text: "Training and combat sports as a practical standard for consistency, focus and resilience when motivation disappears." },
      { title: "Perspective & environment", text: "Technology, machines, travel and ideas that sharpen judgment and widen the context behind decisions." },
    ],
    network: "Follow the part of the work and life that helps you move",
    channels: {
      ...
      tiktok: "Short observations, ideas and experiments built for fast attention.",
      x: "Concise thoughts on business, systems, decisions and execution.",
      telegram: "Direct updates, working notes and things that do not fit the other platforms.",
    },
  },
  ua: {
    eyebrow: "Vlad Kuzmenko",
    titleA: "Будувати те, що ",
    titleB: "працює в реальності.",
    p1: "Мій фокус простий: перетворювати увагу на попит, попит — на робочі системи, а ідеї — на продукти, якими люди реально користуються. Інструменти змінюються, стандарт — ні.",
    p2: "Той самий стандарт я переношу за межі клієнтської роботи: тренування, технології, машини, середовище та рішення, які на довгій дистанції посилюють якість виконання.",
    lanes: [
      { title: "Бізнес і системи", text: "Попит, сайти, AI, автоматизація та продажі як один шлях від уваги до вимірюваного бізнес-результату." },
      { title: "Дисципліна і форма", text: "Тренування та єдиноборства як практичний стандарт послідовності, концентрації й витривалості, коли мотивація зникає." },
      { title: "Середовище і перспектива", text: "Технології, машини, подорожі та ідеї, які загострюють судження й розширюють контекст рішень." },
    ],
    network: "Оберіть ту частину роботи й життя, яка допомагає рухатися вам",
    channels: {
      ...
      tiktok: "Короткі спостереження, ідеї та експерименти, створені для швидкої уваги.",
      x: "Короткі думки про бізнес, системи, рішення та виконання.",
      telegram: "Прямі оновлення, робочі нотатки й те, що не підходить іншим платформам.",
    },
  },
  ru: {
    eyebrow: "Vlad Kuzmenko",
    titleA: "Строить то, что ",
    titleB: "работает в реальности.",
    p1: "Мой фокус простой: превращать внимание в спрос, спрос — в работающие системы, а идеи — в продукты, которыми люди реально пользуются. Инструменты меняются, стандарт — нет.",
    p2: "Тот же стандарт я переношу за пределы клиентской работы: тренировки, технологии, машины, среда и решения, которые на длинной дистанции усиливают качество реализации.",
    lanes: [
      { title: "Бизнес и системы", text: "Спрос, сайты, AI, автоматизация и продажи как один путь от внимания до измеримого бизнес-результата." },
      { title: "Дисциплина и форма", text: "Тренировки и единоборства как практический стандарт последовательности, концентрации и выдержки, когда мотивация исчезает." },
      { title: "Среда и перспектива", text: "Технологии, машины, путешествия и идеи, которые обостряют суждение и расширяют контекст решений." },
    ],
    network: "Выберите ту часть работы и жизни, которая помогает двигаться вам",
    channels: {
      ...
      tiktok: "Короткие наблюдения, идеи и эксперименты, созданные для быстрого внимания.",
      x: "Короткие мысли о бизнесе, системах, решениях и реализации.",
