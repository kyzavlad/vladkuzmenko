  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        ...
        <div
          className="absolute inset-0 opacity-[.024] mix-blend-soft-light"
          style={{
            backgroundImage:
      ...
      <div className="container relative z-10 mx-auto flex w-full justify-center px-5 pb-[250px] pt-[112px] sm:px-6 sm:pb-[228px] sm:pt-[116px] lg:pb-[206px] lg:pt-[98px]">
        <div className="mx-auto flex w-full max-w-[1240px] flex-col items-center text-center">
          ...
          <div className="relative mt-6 w-full">
            ...
            <span
              aria-hidden="true"
              className="pointer-events-none absolute left-[3%] top-[20%] hidden h-[58%] w-px bg-gradient-to-b from-transparent via-amber-200/[.09] to-transparent lg:block"
            />
            <span
              aria-hidden="true"
              className="pointer-events-none absolute right-[3%] top-[20%] hidden h-[58%] w-px bg-gradient-to-b from-transparent via-amber-200/[.09] to-transparent lg:block"
            />

            <motion.h1
              initial={reduced ? false : { opacity: 0, y: 22 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.84, delay: reduced ? 0 : 0.1, ease: [0.16, 1, 0.3, 1] }}
              className="relative z-20 w-full overflow-visible px-1 text-white sm:px-4"
            >
              ...
              <span className="font-display mx-auto mt-2 block max-w-[1210px] overflow-visible pb-[.18em] text-[clamp(2.9rem,5.4vw,5rem)] font-normal leading-[1.06] tracking-[-.036em] text-zinc-100">
                {x.headlineB}{" "}
                <em className="relative inline-block overflow-visible bg-gradient-to-br from-[#fff0a2] via-[#e2b62d] to-[#8c6207] bg-clip-text pb-[.10em] pl-[.04em] pr-[.12em] font-normal italic text-transparent drop-shadow-[0_12px_36px_rgba(212,175,55,.14)]">
                  {x.headlineAccent}
                  <span
                    id="hero-signal-source"
                    aria-hidden="true"
                    className="ml-[.075em] inline-block h-[.105em] w-[.105em] translate-y-[.08em] rounded-full bg-[#e2b62d] shadow-[0_0_18px_rgba(226,182,45,.58)]"
                  />
          ...
          <motion.p
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.72, delay: reduced ? 0 : 0.18, ease: [0.16, 1, 0.3, 1] }}
            className="relative z-20 mt-2 max-w-[780px] text-[12px] leading-6 text-zinc-400 sm:text-[14px] sm:leading-7 lg:text-[15px]"
          >
            {x.desc}
          </motion.p>
